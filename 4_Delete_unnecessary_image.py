...
# 遍历指定目录，显示目录下的所有文件名
filepath=r'/home/duanyajun/文档/个人文档/目标识别项目学习/图像处理工具代码/水柱检测2019-12/image/1'
...
for allDir in pathDir:
    ...
    #print(temp)
    child = os.path.join('%s/%s' % ('/home/duanyajun/文档/个人文档/目标识别项目学习/图像处理工具代码/水柱检测2019-12/image/ann', temp))
...
#            os.remove(child)
        ...
        de=os.path.join('%s/%s' % ('/home/duanyajun/文档/个人文档/目标识别项目学习/图像处理工具代码/水柱检测2019-12/image/1', allDir))
        os.remove(de)
